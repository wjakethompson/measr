...
- The `.data` placeholder is an object that represents the current slice
  of data. If you have a variable name in a string, use the `.data`
  placeholder to subset that variable with `[[`.
...
See documentation for specific functions in
