...
For our estimated LCDM, we see an M<sub>2</sub> value of `r fmt_digits(ecpe_lcdm$fit$m2$m2, digits = 1)`, which has a corresponding *p*-value of `r ifelse(ecpe_lcdm$fit$m2$pval < .01, "<.01", fmt_digits(ecpe_lcdm$fit$m2$pval, digits = 2))`.
...
fit_ppmc(ecpe_lcdm, model_fit = "raw_score", item_fit = NULL, return_draws = 1)
```
