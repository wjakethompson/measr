...
If not other arguments are provided, sensible defaults (described below) will take care of the rest of the specification and estimation.
...
In the code to estimate the LCDM above, no prior distributions were specified.
