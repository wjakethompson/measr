...
public:
  ...
  model_gqs_loglik(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_gqs_loglik_namespace::model_gqs_loglik";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_gqs_loglik_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    (void) jacobian__;
    static constexpr const char* function__ =
      "model_gqs_loglik_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
      current_statement__ = 1;
      ...
      for (int r = 1; r <= R; ++r) {
        ...
        stan::model::assign(log_lik, stan::math::log_sum_exp(prob_joint),
          "assigning variable log_lik", stan::model::index_uni(r));
      }
      out__.write(log_lik);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"log_Vc\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(C) + "},\"block\":\"parameters\"},{\"name\":\"pi\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(I) + ",\"cols\":" + std::to_string(C) + "},\"block\":\"parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(R) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_gen_quantities = emit_generated_quantities * (R);
