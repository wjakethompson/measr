...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'gqs_probs', line 23, column 15 to column 16)",
                                                      " (in 'gqs_probs', line 23, column 4 to column 29)",
                                                      " (in 'gqs_probs', line 25, column 12 to column 18)",
                                                      " (in 'gqs_probs', line 25, column 6 to column 35)",
                                                      " (in 'gqs_probs', line 27, column 8 to column 37)",
                                                      " (in 'gqs_probs', line 28, column 8 to line 29, column 68)",
                                                      " (in 'gqs_probs', line 26, column 26 to line 30, column 7)",
                                                      " (in 'gqs_probs', line 26, column 6 to line 30, column 7)",
                                                      " (in 'gqs_probs', line 31, column 6 to column 49)",
                                                      " (in 'gqs_probs', line 24, column 19 to line 32, column 5)",
                                                      " (in 'gqs_probs', line 24, column 4 to line 32, column 5)",
                                                      " (in 'gqs_probs', line 33, column 4 to column 72)",
                                                      " (in 'gqs_probs', line 22, column 17 to line 34, column 3)",
                                                      " (in 'gqs_probs', line 22, column 2 to line 34, column 3)",
                                                      " (in 'gqs_probs', line 37, column 17 to column 18)",
                                                      " (in 'gqs_probs', line 37, column 6 to column 36)",
                                                      " (in 'gqs_probs', line 39, column 8 to column 63)",
                                                      " (in 'gqs_probs', line 38, column 21 to line 40, column 7)",
                                                      " (in 'gqs_probs', line 38, column 6 to line 40, column 7)",
                                                      " (in 'gqs_probs', line 41, column 6 to column 49)",
                                                      " (in 'gqs_probs', line 36, column 19 to line 42, column 5)",
                                                      " (in 'gqs_probs', line 36, column 4 to line 42, column 5)",
                                                      " (in 'gqs_probs', line 35, column 17 to line 43, column 3)",
                                                      " (in 'gqs_probs', line 35, column 2 to line 43, column 3)",
...
public:
  ...
  inline std::string model_name() const final { return "model_gqs_probs"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_gqs_probs(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_gqs_probs_namespace::model_gqs_probs";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_gqs_probs_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_gqs_probs_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"log_Vc\",\"type\":{\"name\":\"vector\",\"length\":" << C << "},\"block\":\"parameters\"},{\"name\":\"pi\",\"type\":{\"name\":\"matrix\",\"rows\":" << I << ",\"cols\":" << C << "},\"block\":\"parameters\"},{\"name\":\"prob_resp_class\",\"type\":{\"name\":\"matrix\",\"rows\":" << R << ",\"cols\":" << C << "},\"block\":\"generated_quantities\"},{\"name\":\"prob_resp_attr\",\"type\":{\"name\":\"matrix\",\"rows\":" << R << ",\"cols\":" << A << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
