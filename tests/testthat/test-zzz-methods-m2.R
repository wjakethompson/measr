test_that("m2 works", {
  ...
  expect_equal(m2$m2, 1471.7, tolerance = 0.1)
  expect_equal(m2$df, 529)
  expect_equal(m2$pval, 0, tolerance = 0.1)
  expect_equal(m2$rmsea, 0.0422, tolerance = 0.01)
  expect_equal(m2$ci_lower, 0.0392, tolerance = 0.01)
  expect_equal(m2$ci_upper, 0.0453, tolerance = 0.01)
  expect_equal(m2$srmsr, 0.0589, tolerance = 0.1)
