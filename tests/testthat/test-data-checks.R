test_that("multiplication works", {
  ...
  expect_identical(check_file(file, create_dir = FALSE, check_file = TRUE),
                   file)
  expect_identical(check_file(file, ext = "rds", check_file = FALSE),
                   fs::path_ext_set(file, "rds"))
  expect_identical(check_file(fs::path_ext_set(file, "rds"),
                              check_file = FALSE),
                   fs::path_ext_set(file, "rds"))
  expect_identical(check_file(fs::path(dir, "directory", "file"),
                              create_dir = TRUE, check_file = FALSE),
