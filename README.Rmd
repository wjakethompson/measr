...
For a quicker estimation, we can use Stan's optimizer instead of MCMC by adding `method = "optim"` to the function call.
However, please not that some functionality will be lost when using the optimizer (e.g., the calculation of relative fit criteria requires the use of MCMC).
...
To ensure a smooth process, please review the [Contributing Guide](https://measr.info/CONTRIBUTING.html).
