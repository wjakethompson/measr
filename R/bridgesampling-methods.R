                                     ...
                                     silent = FALSE, verbose = FALSE, ...)
{
  ...
  upars_args <- bridgesampling:::.restructure_upars(upars, use_neff)
  bs_args <- list(log_posterior = bridgesampling:::.cmdstan_log_posterior,
  ...
  if (cores == 1) {
    bridge_output <- do.call(what = paste0(".bridge.sampler.",
                                           method),
