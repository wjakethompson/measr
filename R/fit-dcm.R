...
#'     \href{../../cmdstanr/html/model-method-sample.html}{`$sample()`} or
#'     \href{../../cmdstanr/html/model-method-optimize.html}{`$optimize()`}
#'     methods of the \href{../../cmdstanr/html/CmdStanModel.html}{CmdStanModel}
#'     class.
#'
