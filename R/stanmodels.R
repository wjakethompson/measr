...
stanmodels <- c("gqs_loglik", "gqs_ppmc", "gqs_probs", "test_dina", "test_dino", "test_lcdm")
...
Rcpp::loadModule("stan_fit4test_dino_mod", what = TRUE)
Rcpp::loadModule("stan_fit4test_lcdm_mod", what = TRUE)
